...
export const pox: ClarityAbi = {
  functions: [
    ...
    { name: 'check-caller-allowed', access: 'private', args: [], outputs: { type: 'bool' } },
    {
    ...
    { name: 'current-pox-reward-cycle', access: 'private', args: [], outputs: { type: 'uint128' } },
    {
    ...
    { name: 'get-stacking-minimum', access: 'read_only', args: [], outputs: { type: 'uint128' } },
    {
